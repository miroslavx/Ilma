...
--
-- Хост: 127.0.0.1
-- Время создания: Май 14 2025 г., 19:55
...
-- База данных: `ilmadb`
--
CREATE DATABASE IF NOT EXISTS `ilmadb` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `ilmadb`;

-- --------------------------------------------------------

--
-- Структура таблицы `ilmatemperatuurid`
--

CREATE TABLE `ilmatemperatuurid` (
  `id` int(11) NOT NULL,
  `temperatuur` decimal(5,2) DEFAULT NULL,
  `kuupaev_kellaaeg` datetime DEFAULT NULL,
  `maakond_id` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Дамп данных таблицы `ilmatemperatuurid`
--

INSERT INTO `ilmatemperatuurid` (`id`, `temperatuur`, `kuupaev_kellaaeg`, `maakond_id`) VALUES
(1, 10.50, '2023-10-26 10:00:00', 1),
(2, -2.30, '2023-10-26 11:00:00', 2),
(3, 15.00, '2023-10-25 14:30:00', 3),
(4, -5.00, '2023-10-27 08:00:00', 1),
(5, 8.70, '2023-10-27 09:15:00', 2);

-- --------------------------------------------------------

--
-- Структура таблицы `maakonnad`
--

CREATE TABLE `maakonnad` (
  `id` int(11) NOT NULL,
  `maakonnanimi` varchar(100) NOT NULL,
  `maakonnakeskus` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Дамп данных таблицы `maakonnad`
--

INSERT INTO `maakonnad` (`id`, `maakonnanimi`, `maakonnakeskus`) VALUES
(1, 'Harjumaa', 'Tallinn'),
(2, 'Läänemaa', 'Haapsalu'),
(3, 'Tartumaa', 'Tartu'),
(4, 'Pärnumaa', 'Pärnu'),
...
--
-- Индексы таблицы `ilmatemperatuurid`
--
ALTER TABLE `ilmatemperatuurid`
  ADD PRIMARY KEY (`id`),
  ADD KEY `maakond_id` (`maakond_id`);

--
-- Индексы таблицы `maakonnad`
--
ALTER TABLE `maakonnad`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `maakonnanimi` (`maakonnanimi`);
...
--
-- AUTO_INCREMENT для таблицы `ilmatemperatuurid`
--
ALTER TABLE `ilmatemperatuurid`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT для таблицы `maakonnad`
--
ALTER TABLE `maakonnad`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
-- Ограничения внешнего ключа таблицы `ilmatemperatuurid`
--
ALTER TABLE `ilmatemperatuurid`
  ADD CONSTRAINT `ilmatemperatuurid_ibfk_1` FOREIGN KEY (`maakond_id`) REFERENCES `maakonnad` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;
--
...
('root', '2025-05-14 17:14:16', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"ru\"}');
